  ...
  .container.tarjeta.tarjeta--blanca.p-4.p-md-5
    ...
    .row.mb-5.justify-content-center.align-items-center.align-items-lg-stretch
      ...
      .col-12.col-md-8.col-lg-9
        .titulo-segundo
          h2 Identificación de dientes por nomenclatura internacional
        p.mb-4 Determinar las características para la realización de prótesis totales, teniendo en cuenta los protocolos de fabricación. 
